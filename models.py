# Afzaal Hussain 10460
# Web App Activity No 03
...
class UserProfile(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, null=True, editable=False,
                                   related_name='userprofile_creator')
    ...
    def update(self, updated_by *args,
...
class VehicleModel(models.Model):
    ...
    date_created = models.DateTimeField(default=timezone.now, null=False, editable=False)
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, null=True, editable=False,
                                   related_name='Vehiclemodel_creator')
    data_updated = models.DateTimeField(null=True)
